...
export const asyncRouterMap = [
...

  {
    ...
    children: [
      { path: 'member/index', component: _import('member/index'), name: 'memberList', meta: { title: 'memberList' }},
      { path: 'member/application', component: _import('member/application'), name: 'memberApplication', meta: { title: 'memberApplication' }}
    ]
  },
